...
@Configuration
@EnableConfigurationProperties(DataSourceConfig.ValidatedDataSourceProperties.class)
public class DataSourceConfig {
    /*
       ...
       Supports validation
       Clean for large configs
     */
    @Validated
    @ConfigurationProperties("spring.datasource")
    public static class ValidatedDataSourceProperties {
    ...
    // Spring will inject the auto-created bean
    @Bean
    public DataSource dataSource(ValidatedDataSourceProperties props) {
